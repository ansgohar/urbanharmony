                            ...
                            <div className="carousel-inner">
                                <div className="item active">
                                    <div className="image-container-16x5">
                                        <img src="assets/images/sections/slider_img_01.jpg" className="carouselImg"
                                             alt="1"/>
                                    </div>
                                    <TopNews news={this.props.internalnews[0]}
                            ...
                            <div className="col-xs-12 col-sm-5 sec2RightSide nopadding-mobile">
                                <div className="image-container-16x9">
                                    <iframe className="videoDisplay col-xs-12"
                                            width="560" height="315" src={this.state.spotlight}
                        ...
                        <div className="col-xs-12 col-sm-6 sec3LeftSide">
                            ...
                            <div className="col-xs-12 col-sm-10 downCard leftCard no-padding serviceCard">
                                ...
                                <div className="col-xs-12 col-sm-5 cardText">
                                    ...
                                    <p>
                                        دليل لبعض المكاتب الاستشارية التى يمكن التعامل معها لتوفير تصاميم وفقا لمعاير
                                        الجهاز
                                    </p>
                        ...
                        <div className="col-xs-12 col-sm-6 sec3RightSide">
                            <div className="col-xs-12 col-sm-10 upperCard rightCard no-padding serviceCard">
                                ...
                                <div className="col-xs-12 col-sm-5 cardText">
                                    ...
                                    <p>
                                        فى ضوء صدور القانون رقم 144 لسنه 2006 بشأن الحفاظ على المبانى ذات الطراز
                                        المعمارى المتميز وقد تشكلت لجان لحصر المبانى والمنشآت الصادر بها قرار من المحافظ
                                        المختص وتقوم لجنة حصر المبانى والمنشآت بقيد العقارات المحظور هدمها فى سجلات يوضح
                                        بها أسباب القيد للمبانى والمنشآت
                                    </p>
                                    ...
                                    <div className="card col-xs-12 no-padding">
                                        <div className="cardImgContainer col-xs-12 no-padding">
                                            <div className="image-container-4x3">
                                                <img className="cardImg"
                                                     src="assets/images/sections/competition_01.jpg"/>
                                            </div>
                                        </div>
                                        <div className="col-xs-12 comp-textitems-cont no-padding">
                                            ...
                                            <div className="col-xs-12 cardBtn stickTotheBottom">
                                                <a href="/competitionDetails" className="actionBtn 	btn">للإشتراك في
                                                    المسابقة </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="cardContainer col-xs-12  col-sm-6 nopadding-mobile">
                                    <div className="card col-xs-12 middleCard no-padding">
                                        <div className="cardImgContainer col-xs-12 no-padding">
                                            <div className="image-container-4x3">
                                                <img className="cardImg"
                                                     src="assets/images/sections/competition_02.jpg"/>
                                            </div>
                                        </div>
                                        <div className="col-xs-12 comp-textitems-cont no-padding">
                                            <div className="cardText col-xs-12">
                                                <p>الان يمكنك معرفة ميعاد و تاريخ جميع الندوات والمؤتمرات التي
                                                    ستقام </p>
                                                <a href="/conferences">المزيد</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
