            ...
            <div className="tile newsCard col-xs-12 nopadding-mobile">
                <div className="col-xs-12 newscard-container no-padding">
                    <div className="col-xs-12 col-sm-3 news-rightSide nopadding-mobile">
                        {this.props.record.newImage1 && this.props.record.newImage1 !==
                        `http://${config.host}:${config.cms_port}` || this.props.record.newImage1 !==
                        'http://localhost:1337' ?
                            <div className="image-container-4x3"><Image src={this.props.record.newImage1} /></div> : ''}
                    </div>
